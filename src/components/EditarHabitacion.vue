...
<div v-if="!showDetails" class="contenido ml-0 sm:ml-64 ease-in-out transition-all duration-500 p-10" id="contenido">
    <h1 class="text-4xl font-bold">Editar Habitacion</h1>
    <div class="container mx-auto mt-10">
        ...
        <div class="flex justify-between items-center mt-10">
            ...
            <button @click ="loadComponent('DetallesHabitacion')" class="border-gray-500 text-gray-500 hover:bg-blue-500 hover:text-white font-bold py-2 px-4 rounded">
             Regresar
            </button>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <h2 class="text-lg leading-6 font-medium text-gray-900">Guardar Cambios</h2>
          <div class="mt-2">
            <p class="text-sm leading-5 text-gray-500">¿Desea  Guardar los Cambios?</p>
          </div>
        </div>
...
import DetallesHabitacion from './DetallesHabitacion.vue';
...
export default{
    ...
    if (nombreComponente === 'DetallesHabitacion') {
      this.currentComponent = DetallesHabitacion;
  ...
  openModal() {
    ...
    confirm() {
      ...
      Swal.fire({
        icon: 'success',
        title: '¡Guardado!',
        text: 'Los cambios han sido subido con exitos.',
      })
    },
    cancel() {
      this.showModal = false;
